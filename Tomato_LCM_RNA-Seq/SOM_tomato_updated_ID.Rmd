...
expression <- sub.group[c(2,11,13,10,12)]
...
pdf("node1.boxplot.LCM.3x2.pdf", width=4, height=8)
...
expression <- data[c(2,11,13,10,12,18)]
...
data.c <- subset(data.c[c(2,4,1,3)])
